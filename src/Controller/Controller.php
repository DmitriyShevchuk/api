...
class Controller extends AbstractController
{
    ...
    public const USERS_DATA = [
        ...
        [
            'id'    => '2',
            'email' => 'brick.biceps@shredded.com',
            'name'  => 'Brick Biceps'
        ],
        [
            'id'    => '3',
            'email' => 'sigma.male@alphagang.net',
            'name'  => 'Sigma Male'
        ],
        [
            'id'    => '4',
            'email' => 'uwu.catgirl@nyaa.jp',
            'name'  => 'UwU Catgirl'
        ],
        [
            'id'    => '5',
            'email' => 'shreklover420@swamp.com',
            'name'  => 'Shrek Fan 420'
        ],
        [
            'id'    => '6',
            'email' => 'batman.real@notbrucewayne.com',
            'name'  => 'Totally Not Batman'
        ],
        [
            'id'    => '7',
            'email' => 'mr.beastmode@cashmoney.biz',
            'name'  => 'Mr. Beastmode'
        ],
    ];
